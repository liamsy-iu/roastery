      ...
      <div className="hero-content container">
        <div className="hero-text">
          <p className="section-label" style={{ color: "var(--gold-light)" }}>
            Specialty Coffee Roastery — Madinah
          </p>
          <h1 className="hero-headline">
            Coffee roasted<br />
            <em>at its finest</em><br />
            moment.
          </h1>
          ...
          <div className="hero-actions">
            ...
            <a href="#story" className="btn-outline" style={{ borderColor: "rgba(245,239,224,0.4)", color: "var(--cream)" }}>
              Our Story
            </a>
          </div>
        </div>
        ...
        <div className="hero-stats">
          <div className="stat">
            ...
            <span className="stat-label">Roast<br />precision</span>
          </div>
          <div className="stat-divider" />
          <div className="stat">
            <span className="stat-num">12+</span>
            <span className="stat-label">Origins<br />sourced</span>
          </div>
          <div className="stat-divider" />
          <div className="stat">
            <span className="stat-num">48h</span>
            <span className="stat-label">Fresh<br />delivery</span>
          </div>
        </div>
      </div>
