...
const REASONS = [
  ...
  },
  {
    ...
    title: "Free Delivery",
    body: "We ship free to all cities across Saudi Arabia. Orders placed before noon are dispatched same day, and arrive within 48 hours.",
  },
  {
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2">
      ...
      <div className="container">
        ...
        <div className="whyus-banner">
          ...
          <div className="whyus-banner-overlay">
            <blockquote>
              "We named ourselves after the temperature that unlocks the soul
              of every bean. That precision is in everything we do."
            </blockquote>
            <cite>— The 65° Team, Madinah</cite>
          </div>
        </div>
      </div>
    </div>
