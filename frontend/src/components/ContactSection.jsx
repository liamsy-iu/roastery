      ...
      <div className="container contact-inner">
        <div className="contact-info">
          ...
          <p className="contact-body">
            Whether you're curious about a specific origin, need help choosing a
            subscription, or want to arrange a bulk order — we're here.
          </p>
          ...
          {status === "sent" ? (
            <div className="form-success">
              ...
              <p>
                ...
                free to WhatsApp us for a faster response.
              </p>
