  ...
  return (
    <div className="invoice-doc">
      ...
      <div className="invoice-bill-to">
        ...
        {order.notes && (
          <div
            className="invoice-customer-detail"
...
export default function Admin() {
  ...
  }, [authed, fetchOrders, fetchProducts, fetchLeads, fetchDiscounts]);
  ...
  return (
    <div className="admin-wrap">
      ...
      <main className="admin-main">
                  ...
                  {products.map((p) => (
                    <div key={p.id} className="admin-product-mobile-card">
                      <img
                        src={p.image}
                        alt={p.name}
                        className="admin-product-mobile-img"
                      />
                      <div className="admin-product-mobile-body">
                        ...
                        <div
                          className="admin-product-mobile-row"
                          style={{ marginTop: 4 }}
                        >
                          <span
        ...
        {tab === "leads" && (
          <>
            <div className="admin-toolbar">
              <div>
                <h2 className="admin-section-title">Wholesale Leads</h2>
                <p className="admin-section-sub">
              ...
              <div style={{ display: "flex", gap: 8 }}>
                {["all", "new", "contacted", "converted"].map((s) => (
                  <button
                    key={s}
                    className={`filter-pill ${leadFilter === s ? "active" : ""}`}
                ...
                <button className="admin-btn-ghost-dark" onClick={fetchLeads}>
                  ↻ Refresh
                </button>
              </div>
            </div>
            ...
            {leadsLoading ? (
              ...
              <div className="admin-empty">
                <p>
                  No {leadFilter === "all" ? "" : leadFilter + " "}wholesale
                  leads yet.
                </p>
              </div>
            ) : (
              <div className="admin-orders-list">
                {leads
                  ...
                  .map((lead) => (
                    <div key={lead.id} className="admin-order-card">
                      <div
                        className="admin-order-header"
                      ...
                      >
                        <div className="admin-order-meta">
                          ...
                          <span
                            className={`order-status-badge ${lead.status === "new" ? "status-new" : lead.status === "contacted" ? "status-confirmed" : "status-delivered"}`}
                          >
                            {lead.status}
                          </span>
                        </div>
                      ...
                      {lead.message && (
                        <div
                          className="admin-order-body"
                          style={{ padding: "12px 18px" }}
                        >
                          <p className="order-section-label">Note</p>
                          <p
                            style={{
                              fontSize: 13,
                              color: "var(--text-muted)",
        ...
        {tab === "discounts" && (
          <>
            ...
            <div className="discount-create-card">
              <h3 className="discount-create-title">Create New Code</h3>
              <div className="discount-create-grid">
                <div className="admin-field">
                  <label>Code</label>
                  <input
                    value={newCode.code}
                ...
                <div className="admin-field">
                  ...
                  <input
                    ...
                    placeholder={
                      newCode.type === "percent" ? "e.g. 10" : "e.g. 500"
                    }
                  />
                </div>
                <div
                  ...
                  <button
                    ...
                    onClick={async () => {
                      if (!newCode.code || !newCode.value) {
                        setCodeError("Please fill in code and value.");
                        return;
                      }
                      try {
                        const res = await fetch(`${API}/admin/discounts`, {
                        ...
                        setCodeError("Failed to create code.");
                      }
                    }}
                  >
                    Create Code
                  ...
                  <tbody>
                    {discounts.map((d) => (
                      <tr key={d.code}>
                        ...
                        <td>
                          <span className="admin-category-tag">{d.type}</span>
                        </td>
                        <td className="admin-price">
                          {d.type === "percent"
                            ? `${d.value}%`
                        ...
                        <td>
                          <button
                            className={`admin-stock-toggle ${d.active ? "in" : "out"}`}
                            onClick={async () => {
                              await fetch(
                                `${API}/admin/discounts/${d.code}/toggle`,
                                {
                                  method: "PATCH",
                                  headers: authHeaders(creds.user, creds.pass),
                                },
                        ...
                        <td>
                          <button
                            ...
                            onClick={async () => {
                              ...
                              await fetch(`${API}/admin/discounts/${d.code}`, {
                                method: "DELETE",
                                headers: authHeaders(creds.user, creds.pass),
                              });
                              fetchDiscounts();
      ...
      {invoiceOrder && (
        ...
        >
          <div
            className="admin-modal invoice-modal"
